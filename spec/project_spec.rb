...
describe("#id") do
  ...
  describe("#get_volunteers") do
    it("returns an array of volunteers for that project") do
      ...
      project1.save
      volunteer1 = Volunteer.new({volunteer_name: "Epona", project_id: project1.id, id: nil})
      volunteer1.save
      volunteer2 = Volunteer.new({volunteer_name: "Navi", project_id: project1.id, id: nil})
      volunteer2.save
  ...
  describe('#delete') do
    ...
    it('also deletes the volunteers from the deleted project') do
      ...
      project1.save
      volunteer1 = Volunteer.new({volunteer_name: "Malon", project_id: project1.id, id: nil})
      volunteer1.save
      volunteer2 = Volunteer.new({volunteer_name: "Talon", project_id: project1.id, id: nil})
      volunteer2.save
      project1.delete
